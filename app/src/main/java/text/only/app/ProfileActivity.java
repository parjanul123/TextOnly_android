...
public class ProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = findViewById(R.id.toolbarProfile); // Assuming you have a toolbar with this ID
    ...
    private void loadProfileData() {
        ...
        if (imageUriString != null) {
            try {
                ...
                imgProfile.setImageResource(R.mipmap.textonly_round); 
            }
        }
    ...
    private void saveProfileData() {
        ...
        Toast.makeText(ProfileActivity.this, "Nume salvat local! ✅", Toast.LENGTH_SHORT).show();
        
        // --- ÎNCERCARE SALVARE SERVER (OPȚIONAL) ---
        // Nu blocăm interfața dacă serverul nu răspunde, doar încercăm în fundal
        sendProfileToBackend(name);
        
        // Închidem activitatea pentru a reflecta schimbările
        // Sau rămânem aici, dar anunțăm userul
        // finish(); // Decomentează dacă vrei să iasă după salvare
    }
    ...
    private void sendProfileToBackend(String name) {
        ...
        // Nu mai schimbăm textul butonului, lăsăm utilizatorul să interacționeze
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                // Ignorăm eroarea de server, am salvat local deja
                Log.e("ProfileActivity", "Eroare conexiune server (ignorat, salvat local)", e);
            }

            @Override
            public void onResponse(Call call, Response response) throws IOException {
                // Succes silențios sau log
                 if (!response.isSuccessful()) {
                      Log.e("ProfileActivity", "Server reject: " + response.code());
                 }
            }
        });
    }
